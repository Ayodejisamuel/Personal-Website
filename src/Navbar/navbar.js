    ...
    return (
        <section id='navbar'>
            ...
            <div className='links'>
                ...
                <Link smooth={true} spy={true} className='desktopLink' offset={-100} duration={500} activeClass="active" to="skill">About</Link>
            ...
            <div  onClick={() => setMobMenu(!mobMenu)} className='mobMenu'><img src={hamburger} /></div>
            <div className='navmenu' style={{ display: mobMenu ? 'flex' : 'none' }} >
                ...
                <Link onClick={() => setMobMenu(false)} smooth={true} spy={true} className='mobLink' offset={-100} duration={500} activeClass="activ" to="skill">About</Link>
